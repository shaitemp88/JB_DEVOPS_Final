pipeline {
	...
	environment {
        ...
        GITACCESSTOKEN = "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"
	}
    stages {
        stage ('Init') {
            steps {
        ...
        stage ('Merge dev with branch'){
            steps {
                script {
                    ...
                    sh 'git remote add origin https://x-access-token:$GITACCESSTOKEN@$GITPROJECT.git'
